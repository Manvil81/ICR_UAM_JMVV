...
La Tabla \ref{tab:distribuciones_regiones} muestra las distribuciones que mejor se ajustan para cada región de estudio para magnitudes máximas. En el capítulo 5 se muestra cómo se eligieron y porqué no se incluye ninguna distribución para sismos totales. 
