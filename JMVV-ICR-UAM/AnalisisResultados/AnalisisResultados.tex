...
\begingroup %%CAMBIAR ESTA TABLA A LONGTABLE
\footnotesize
\centering
...
\begingroup %%CAMBIAR ESTA TABLA POR LONGTABLE SI ES MUY LARGA
\footnotesize
\centering
...
\subsection{Oaxaca PBA Sismos Totales}
...
\subsection{Oaxaca PBA Magnitudes Máximas}
...
\subsection{Guerrero PBA Sismos Totales}
...
\subsection{Guerrero PBA Magnitudes Máximas}
...
Los resultados indican que varias distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Guerrero, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, mientras que los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse adecuadamente a los datos según ciertas pruebas, pero no todas las pruebas confirman este ajuste. Se recomienda considerar estas distribuciones para modelar los datos de magnitudes máximas, pero también se sugiere realizar análisis adicionales para confirmar la adecuación del modelo seleccionado.

\subsection{Michoacán PBA Sismos Totales}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Michoacán, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Se recomienda explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\subsection{Michoacán PBA Magnitudes Máximas}
...
Los resultados indican que varias distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Michoacán, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, mientras que los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse adecuadamente a los datos según ciertas pruebas, pero no todas las pruebas confirman este ajuste. Se recomienda considerar estas distribuciones para modelar los datos de magnitudes máximas, pero también se sugiere realizar análisis adicionales para confirmar la adecuación del modelo seleccionado.

\subsection{Chiapas PBA Sismos Totales}
...
\subsection{Chiapas PBA Magnitudes Máximas}
...
Los resultados indican que varias distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Chiapas, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, mientras que los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse adecuadamente a los datos según ciertas pruebas, pero no todas las pruebas confirman este ajuste. Se recomienda considerar estas distribuciones para modelar los datos de magnitudes máximas, pero también se sugiere realizar análisis adicionales para confirmar la adecuación del modelo seleccionado.

\subsection{Resto Nacionales PBA Sismos Totales}
...
\subsection{Resto Nacionales PBA Magnitudes Máximas}
...
Los resultados indican que varias distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Resto Nacionales, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, mientras que los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse adecuadamente a los datos según ciertas pruebas, pero no todas las pruebas confirman este ajuste. Se recomienda considerar estas distribuciones para modelar los datos de magnitudes máximas, pero también se sugiere realizar análisis adicionales para confirmar la adecuación del modelo seleccionado.

\subsection{Sismos Nacionales PBA Sismos Totales}
...
\subsection{Sismos Nacionales PBA Magnitudes Máximas}
...
Los resultados indican que varias distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Sismos Nacionales, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, mientras que los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse adecuadamente a los datos según ciertas pruebas, pero no todas las pruebas confirman este ajuste. Se recomienda considerar estas distribuciones para modelar los datos de magnitudes máximas, pero también se sugiere realizar análisis adicionales para confirmar la adecuación del modelo seleccionado.
