...
\begin{longtable}{|>{\centering\arraybackslash}p{1.6cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{1.3cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|}
\caption{Estadísticos descriptivos consolidados.} \label{tab:estadisticos_consolidados} \\
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Min} & \textbf{Max} & \textbf{Media} & \textbf{Mediana} & \textbf{Moda} & \textbf{Desv.} & \textbf{Var.} & \textbf{Asim.} & \textbf{Curt.} & \textbf{Total} \\
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
\endlastfoot
\rowcolor{gray!20}
Oax. Tot. & 5.0 & 7.8 & 5.445 & 5.20 & 5.0 & 0.618 & 0.382 & 1.935 & 6.092 & 335 \\ \hline
Oax. Máx. & 5.0 & 7.8 & 6.222 & 6.00 & 6.9 & 0.787 & 0.619 & 0.230 & 1.811 & 64 \\ \hline
\rowcolor{gray!20}
Gro. Tot. & 5.0 & 7.8 & 5.573 & 5.30 & 5.0 & 0.695 & 0.483 & 1.390 & 3.854 & 256 \\ \hline
Gro. Máx. & 5.0 & 7.8 & 6.289 & 6.50 & 6.6 & 0.794 & 0.631 & 0.028 & 1.773 & 70 \\ \hline
\rowcolor{gray!20}
Mich. Tot. & 5.0 & 8.1 & 5.610 & 5.30 & 5.0 & 0.797 & 0.636 & 1.479 & 4.024 & 90 \\ \hline
Mich.Máx. & 5.0 & 8.1 & 5.888 & 5.45 & 5.0 & 0.920 & 0.847 & 0.860 & 2.363 & 50 \\ \hline
\rowcolor{gray!20}
Chis. Tot. & 5.0 & 8.2 & 5.395 & 5.20 & 5.0 & 0.559 & 0.313 & 2.114 & 7.373 & 629 \\ \hline
Chis. Máx. & 5.1 & 8.2 & 6.442 & 6.50 & 5.6 & 0.739 & 0.547 & 0.005 & 2.221 & 73 \\ \hline
\rowcolor{gray!20}
R.N. Tot. & 5.0 & 8.2 & 5.568 & 5.30 & 5.0 & 0.612 & 0.375 & 1.401 & 4.376 & 545 \\ \hline
R.N. Máx. & 5.3 & 8.2 & 6.517 & 6.50 & 6.5 & 0.579 & 0.335 & 0.033 & 3.176 & 87 \\ \hline
\rowcolor{gray!20}
Nals. Tot. & 5.0 & 8.2 & 5.490 & 5.20 & 5.0 & 0.623 & 0.389 & 1.715 & 5.340 & 1855 \\ \hline
Nals. Máx. & 5.6 & 8.2 & 7.007 & 7.00 & 7.0 & 0.506 & 0.256 & -0.05 & 2.946 & 110 \\ \hline
\end{longtable}
\endgroup
%% \vspace{10pt}
...
\noindent
Analizando los gráficos para las 6 regiones de la Figura \ref{fig:magnitudes_tiempo} se puede observar que antes de los años 70s del siglo pasado, las líneas de magnitud máxima, promedio y mínima no presentaban prácticamente variaciones para los 4 estados, y presentan muy poca variación para Resto Nacional y Sismos Nacionales en este periodo. Esto indica que hubo una progresiva mejoría en las técnicas de medición y registro de eventos sísmicos, debido a que antes de esta fecha, sólo se registraban los sismos de magnitudes fuertes, mientras que sismos de magnitudes más pequeñas no eran registrados.

También podemos observar sismos de interés en los gráficos de Michoacán y Chiapas, siendo el sismo de septiembre 19 de 1985 el que aparece como un pico en el gráfico de Michoacán, mientras que el pico que se observa en el gráfico de Chiapas corresponde al sismo del 7 de septiembre de 2017, el cual se distingue claramente en su gráfico y que resulta ser el sismo más fuerte registrado en toda la base de datos sísmicos del SSNM hasta el momento.

Y por último, se pueden observar picos representativos de sismos fuertes (mayores a 7.0°) en los gráficos de Oaxaca y Guerrero para los años recientes (2010-2025), indicando que en Oaxaca se prsentaron 2 sismos mayores a 7.0° en este periodo, mientras que en Guerrero se presentaron 3 sismos mayores a 7.0° en este mismo periodo mientras que en Guerrero se presentaron 3 sismos mayores a 7.0° durante este periodo.

Los gráficos de Resto Nacionales y Sismos Nacionales presentan un comportamiento más uniforme, ya que al ser la suma de los sismos de todos los estados, las variaciones individuales de cada estado se ven englobadas en estos gráficos.
...
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Media Totales} & \textbf{LI 95\% Totales} & \textbf{LS 95\% Totales} \\ \hline
\rowcolor{gray!20}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_media_totales.png}
\caption{IC para la media para sismos totales para las 6 regiones.}
...
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Media Máximos} & \textbf{LI 95\% Máximos} & \textbf{LS 95\% Máximos} \\ \hline
\rowcolor{gray!20}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_media_maximas.png}
\caption{IC para la media para magnitudes máximas para las 6 regiones.}
...
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Varianza Totales} & \textbf{LI 95\% Var\_Tot} & \textbf{LS 95\% Var\_Tot} \\ \hline
\rowcolor{gray!20}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_varianza_totales.png}
\caption{IC para la varianza para sismos totales para las 6 regiones.}
...
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Varianza Máximos} & \textbf{LI 95\% Var\_Max} & \textbf{LS 95\% Var\_Max} \\ \hline
\rowcolor{gray!20}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_varianza_maximas.png}
\caption{IC para la varianza para magnitudes máximas para las 6 regiones.}
...
%% ESTA TABLA SE CAMBIA A LONGTABLE PARA MOSTRASR EN VARIAS PAGINAS
% \begingroup
% \footnotesize
% \centering
...
\centering
\setlength{\LTcapwidth}{\textwidth}
%%\begin{longtable}{|>{\centering\arraybackslash}p{2.2cm}|>{\centering\arraybackslash}p{1.8cm}|>{\centering\arraybackslash}p{1.8cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{2cm}|}
\begin{longtable}{|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.7cm}|}
\caption{IC para la proporción de sismos mayores al umbral crítico para sismos totales para las 6 regiones.} \label{tab:ic_proporcion_totales} \\
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Proporción Totales} & \textbf{Porcentaje Totales} & \textbf{LI 95\% Prop\_Tot} & \textbf{LS 95\% Prop\_Tot} & \textbf{LI 95\% Porc\_Tot} & \textbf{LS 95\% Porc\_Tot} \\
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_proporcion_totales.png}
...
\hline
\rowcolor{gray!60}
\textbf{Región} & \textbf{Proporción Máximos} & \textbf{Porcentaje Máximos} & \textbf{LI 95\% Prop\_Max} & \textbf{LS 95\% Prop\_Max} & \textbf{LI 95\% Porc\_Max} & \textbf{LS 95\% Porc\_Max} \\ \hline
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{ic_proporcion_maximas.png}
...
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Prop\_1} & \textbf{Prop\_2} & \textbf{Diferencia} & \textbf{Z\_est.} & \textbf{P\_valor} & \textbf{Significativo} \\ \hline
\rowcolor{gray!20}
...
Ahora se presentan dos listas decrecientes con el ranking de regiones con mayor proporción de sismos mayores al umbral, tanto para sismos totales como para magnitudes máximas anuales:
...
\footnotesize
\centering
\begin{tabularx}{15.5cm}{|c|* {6}{>{\centering\arraybackslash}X|}}
...
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Var\_1} & \textbf{Var\_2} & \textbf{F\_est} & \textbf{GL\_num} & \textbf{GL\_den} & \textbf{P\_val} & \textbf{Sig.} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
Oaxaca & Guerrero & 0.3819 & 0.4834 & 1.2656 & 255 & 334 & 0.0439 & Sí & Gro. $>$ Oax. \\ \hline
Oaxaca & Mich. & 0.3819 & 0.6357 & 1.6645 & 89 & 334 & 0.0014 & Sí & Mich. $>$ Oax. \\ \hline
\rowcolor{gray!20}
Oaxaca & Chiapas & 0.3819 & 0.3129 & 1.2207 & 334 & 628 & 0.0348 & Sí & Oax. $>$ Chis. \\ \hline
Oaxaca & R.N. & 0.3819 & 0.3751 & 1.0182 & 334 & 544 & 0.8485 & No & Sin dif. \\ \hline
\rowcolor{gray!20}
Oaxaca & Nals. & 0.3819 & 0.3887 & 1.0177 & 1854 & 334 & 0.8498 & No & Sin dif. \\ \hline
Guerrero & Mich. & 0.4834 & 0.6357 & 1.3152 & 89 & 255 & 0.1025 & No & Sin dif. \\ \hline
\rowcolor{gray!20}
Guerrero & Chiapas & 0.4834 & 0.3129 & 1.5449 & 255 & 628 & 0.0000 & Sí & Gro. $>$ Chis. \\ \hline
Guerrero & R.N. & 0.4834 & 0.3751 & 1.2885 & 255 & 544 & 0.0160 & Sí & Gro. $>$ R.N. \\ \hline
\rowcolor{gray!20}
Guerrero & Nals. & 0.4834 & 0.3887 & 1.2435 & 255 & 1854 & 0.0166 & Sí & Gro. $>$ Nals. \\ \hline
Mich. & Chiapas & 0.6357 & 0.3129 & 2.0318 & 89 & 628 & 0.0000 & Sí & Mich. $>$ Chis. \\ \hline
\rowcolor{gray!20}
Mich. & R.N. & 0.6357 & 0.3751 & 1.6947 & 89 & 544 & 0.0004 & Sí & Mich. $>$ R.N. \\ \hline
Mich. & Nals. & 0.6357 & 0.3887 & 1.6355 & 89 & 1854 & 0.0004 & Sí & Mich. $>$ Nals. \\ \hline
\rowcolor{gray!20}
Chiapas & R.N. & 0.3129 & 0.3751 & 1.1989 & 544 & 628 & 0.0281 & Sí & R.N. $>$ Chis. \\ \hline
Chiapas & Nals. & 0.3129 & 0.3887 & 1.2424 & 1854 & 628 & 0.0011 & Sí & Nals. $>$ Chis. \\ \hline
\rowcolor{gray!20}
R.N. & Nals. & 0.3751 & 0.3887 & 1.0362 & 1854 & 544 & 0.6158 & No & Sin dif. \\ \hline
\end{tabularx}
\endgroup
...
Oaxaca & Mich. & 0.6192 & 0.8468 & 1.3676 & 49 & 63 & 0.2406 & No & Sin dif. \\ \hline
\rowcolor{gray!20}
Oaxaca & Chiapas & 0.6192 & 0.5466 & 1.1327 & 63 & 72 & 0.6066 & No & Sin dif. \\ \hline
Oaxaca & R.N. & 0.6192 & 0.3352 & 1.8474 & 63 & 86 & 0.0082 & Sí & Oax. $>$ R.N. \\ \hline
\rowcolor{gray!20}
Oaxaca & Nals. & 0.6192 & 0.2559 & 2.4196 & 63 & 109 & 0.0000 & Sí & Oax. $>$ Nals. \\ \hline
Guerrero & Mich. & 0.6309 & 0.8468 & 1.3422 & 49 & 69 & 0.2578 & No & Sin dif. \\ \hline
\rowcolor{gray!20}
Guerrero & Chiapas & 0.6309 & 0.5466 & 1.1541 & 69 & 72 & 0.5477 & No & Sin dif. \\ \hline
Guerrero & R.N. & 0.6309 & 0.3352 & 1.8823 & 69 & 86 & 0.0055 & Sí & Gro. $>$ R.N. \\ \hline
\rowcolor{gray!20}
Guerrero & Nals. & 0.6309 & 0.2559 & 2.4653 & 69 & 109 & 0.0000 & Sí & Gro. $>$ Nals. \\ \hline
Mich. & Chiapas & 0.8468 & 0.5466 & 1.5491 & 49 & 72 & 0.0896 & No & Sin dif. \\ \hline
\rowcolor{gray!20}
Mich. & R.N. & 0.8468 & 0.3352 & 2.5265 & 49 & 86 & 0.0001 & Sí & Mich. $>$ R.N. \\ \hline
Mich. & Nals. & 0.8468 & 0.2559 & 3.3089 & 49 & 109 & 0.0000 & Sí & Mich. $>$ Nals. \\ \hline
\rowcolor{gray!20}
Chiapas & R.N. & 0.5466 & 0.3352 & 1.6310 & 72 & 86 & 0.0299 & Sí & Chis. $>$ R.N. \\ \hline
Chiapas & Nals. & 0.5466 & 0.2559 & 2.1361 & 72 & 109 & 0.0003 & Sí & Chis. $>$ Nals. \\ \hline
\rowcolor{gray!20}
R.N. & Nals. & 0.3352 & 0.2559 & 1.3097 & 86 & 109 & 0.1827 & No & Sin dif. \\ \hline
\end{tabularx}
\endgroup
...
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Media 1} & \textbf{Media 2} & \textbf{Dif.} & \textbf{T\_est} & \textbf{GL} & \textbf{P\_val} & \textbf{Sig.} & \textbf{Prueba} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
\centering
\setlength{\LTcapwidth}{\textwidth}
\begin{longtable}{|p{1.4cm}|p{1.4cm}|c|c|c|c|c|c|p{3.5cm}|}
\caption{Resultados de las pruebas de hipótesis para proporciones iguales para sismos totales.} \label{tab:hipotesis_proporciones_totales} \\
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Prop\_1} & \textbf{Prop\_2} & \textbf{Dif.} & \textbf{Z\_est} & \textbf{P\_val} & \textbf{Sig.} & \textbf{Interpretación} \\
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Prop\_1} & \textbf{Prop\_2} & \textbf{Dif.} & \textbf{Z\_est} & \textbf{P\_valor} & \textbf{Sig.} & \textbf{Interpretación} \\
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
\hline
\rowcolor{gray!60}
\textbf{Región 1} & \textbf{Región 2} & \textbf{Prop\_1} & \textbf{Prop\_2} & \textbf{Dif.} & \textbf{Z\_est} & \textbf{P\_valor} & \textbf{Sig.} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
\noindent
Se presentan los resultados de las pruebas de bondad de ajuste (PBA) Kolmogorov-Smirnov (KS), Anderson-Darling (AD) y Lilliefors (LF) para evaluar la adecuación de los modelos estadísticos ajustados a los datos de sismos totales y magnitudes máximas anuales en las diferentes regiones de estudio. Estas pruebas permiten determinar si los datos siguen una distribución específica, proporcionando una evaluación cuantitativa del ajuste del modelo.

Los resultados completos de las PBA hechas a 20 distribuciones para cada región se presentan en tablas respectivas para cada región en las secciones siguientes.

\clearpage

\subsection{Oaxaca resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_oaxaca_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Oaxaca.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para sismos totales.} \label{tab:bondad_oaxaca_totales} \\
\hline
\rowcolor{gray!60}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Oaxaca, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultado, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Oaxaca de manera más precisa.

\subsection{Oaxaca resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_oaxaca_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Oaxaca.
...
% \centering
% \begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
% \caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas.} \label{tab:bondad_oaxaca_maximas} \\
% \hline
% \rowcolor{gray!60}
% \textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
% \rowcolor{gray!20}
...
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\
\hline
\endfirsthead
\hline
\rowcolor{gray!60}
...
Los resultados indican que 11 distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Oaxaca, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, también se encuentra que 2 distribuciones probadas muestran un ajuste únicamente para la prueba KS con un valor p mayor a 0.05 y finalmente se encuentra que todos los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse a los datos para ciertas pruebas de bondad. Como resultado se concluye que estas distribuciones sirven para modelar los datos de magnitudes máximas de sismos en Oaxaca.

\subsection{Guerrero resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_guerrero_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Guerrero.
...
% \centering
% \begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
% \caption{Resultados de las pruebas de bondad de ajuste para sismos totales en Guerrero.} \label{tab:bondad_guerrero_totales} \\
% \hline
% \rowcolor{gray!60}
% \textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
% \rowcolor{gray!20}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Guerrero, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultado, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Guerrero de manera más precisa.

\subsection{Guerrero resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_guerrero_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Guerrero.
...
% \centering
% \begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
% \caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas en Guerrero.} \label{tab:bondad_guerrero_maximas} \\
% \hline
% \rowcolor{gray!60}
% \textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
% \rowcolor{gray!20}
...
Los resultados indican que 11 distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Guerrero, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, también se encuentra que 2 distribuciones probadas se ajustan a la prueba KS y 1 distribución probada se ajusta a la prueba AD, ya que tienen un valor p mayor a 0.05 y finalmente se encuentra que todos los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse a los datos para ciertas pruebas de bondad. Como resultado se concluye que estas distribuciones sirven para modelar los datos de magnitudes máximas de sismos en Oaxaca.

\subsection{Michoacán resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_michoacan_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Michoacán.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para sismos totales en Michoacán.} \label{tab:bondad_michoacan_totales} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Michoacán, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultados, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Michoacán de manera más precisa.

\subsection{Michoacán resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_michoacan_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Michoacán.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas en Michoacán.} \label{tab:bondad_michoacan_maximas} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que 11 distribuciones probadas muestran un ajuste parcial a los datos de magnitudes máximas en Michoacán, ya que los valores p asociados a las pruebas KS y AD son mayores que el nivel de significancia de 0.05, también se encuentra que 3 distribuciones probadas muestran un ajuste únicamente para la prueba KS con un valor p mayor a 0.05 y finalmente se encuentra que todos los valores p de la prueba LF son menores que 0.05. Esto sugiere que algunas distribuciones pueden ajustarse a los datos para ciertas pruebas de bondad. Como resultado se concluye que estas distribuciones sirven para modelar los datos de magnitudes máximas de sismos en Michoacán.

\subsection{Chiapas resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_chiapas_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Chiapas.
...
% \centering
% \begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
% \caption{Resultados de las pruebas de bondad de ajuste para sismos totales en Chiapas.} \label{tab:bondad_chiapas_totales} \\
% \hline
% \rowcolor{gray!60}
% \textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
% \rowcolor{gray!20}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Chiapas, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultado, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Chiapas de manera más precisa.

\subsection{Chiapas resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_chiapas_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Chiapas.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas en Chiapas.} \label{tab:bondad_chiapas_maximas} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que 2 distribuciones probadas muestran un ajuste completo para los datos de magnitudes máximas en Chiapas, ya que los valores p asociados a las pruebas KS, AD y LF son mayores que el nivel de significancia de p de 0.05, mientras que 11 distribuciones muestran un ajuste parcial a los datos de magnitudes máximas en Chiapaslos con valores p asociados a las pruebas KS y AD mayores que el nivel de significancia p de 0.05, también se encuentra que 1 distribución probada se ajusta a la prueba KS al tener un valor p mayor a 0.05. Esto sugiere que 2 distribuciones se ajustan a los datos para las tres PBAs para magnitudes máximas en Chiapas. Como resultado se concluye que las distribuciones Weibull y GEV permiten modelar los datos de magnitudes máximas de sismos en Chiapas.

\subsection{Resto Nacionales resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_rn_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Resto Nacionales.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para sismos totales en Resto Nacionales.} \label{tab:bondad_rn_totales} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Resto Nacionales, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultado, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Resto Nacionales de manera más precisa.

\subsection{Resto Nacionales resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_rn_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Resto Nacionales.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas en Resto Nacionales.} \label{tab:bondad_rn_maximas} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que 3 distribuciones probadas muestran un ajuste completo para los datos de magnitudes máximas en Resto Nacionales, ya que los valores p asociados a las pruebas KS, AD y LF son mayores que el nivel de significancia de p de 0.05, mientras que 9 distribuciones muestran un ajuste parcial a los datos de magnitudes máximas en Resto Nacionales con valores p asociados a las pruebas KS y AD mayores que el nivel de significancia de 0.05, también se encuentra que 1 distribución probada se ajusta a la prueba AD al tener un valor p mayor a 0.05. Esto sugiere que 3 distribuciones se ajustan a los datos para las tres PBAs para magnitudes máximas en Resto Nacionales. Como resultado se concluye que las distribuciones Logística, Laplace y T-Student permiten modelar los datos de magnitudes máximas de sismos en Resto Nacionales.

\subsection{Sismos Nacionales resultados de PBA para Sismos Totales}

\noindent
La Tabla \ref{tab:bondad_sn_totales} muestra los resultados de las pruebas de bondad de ajuste para sismos totales en Resto Nacionales.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para sismos totales en Sismos Nacionales.} \label{tab:bondad_sn_totales} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que todas las distribuciones probadas fueron rechazadas en las pruebas de bondad de ajuste KS, AD y LF para los datos de sismos totales en Sismos Nacionales, ya que los valores p asociados a cada prueba son menores que el nivel de significancia de 0.05. Esto sugiere que ninguna de las distribuciones evaluadas se ajusta adecuadamente a los datos de sismos totales en esta región. Como resultado, se recomienda explorar otras distribuciones o enfoques estadísticos para modelar los datos de sismos totales de Sismos Nacionales de manera más precisa.

\subsection{Sismos Nacionales resultados de PBA para Magnitudes Máximas}

\noindent
La Tabla \ref{tab:bondad_sn_maximas} muestra los resultados de las pruebas de bondad de ajuste para magnitudes máximas en Sismos Nacionales.

\begingroup
\footnotesize
\centering
\begin{tabularx}{15.9cm}{|l|c|c|c|c|c|c|X|}
\caption{Resultados de las pruebas de bondad de ajuste para magnitudes máximas en Sismos Nacionales.} \label{tab:bondad_sn_maximas} \\
\hline
\rowcolor{gray!60}
\textbf{Distribución} & \textbf{KS (D)} & \textbf{KS (P)} & \textbf{AD (An)} & \textbf{AD (P)} & \textbf{Lillie (D)} & \textbf{Lillie (P)} & \textbf{Interpretación} \\ \hline
\rowcolor{gray!20}
...
Los resultados indican que 8 distribuciones probadas muestran un ajuste completo para los datos de magnitudes máximas en Sismos Nacionales, ya que los valores p asociados a las pruebas KS, AD y LF son mayores que el nivel de significancia de p de 0.05, mientras que 4 distribuciones muestran un ajuste parcial a los datos de magnitudes máximas en Sismos Nacionales con valores p asociados a las pruebas KS y AD mayores que el nivel de significancia de 0.05, también se encuentra que 4 distribuciones probadas se ajustan a la prueba LF al tener un valor p mayor a 0.05. Esto sugiere que 8 distribuciones se ajustan a los datos para las tres PBAs para magnitudes máximas en Sismos Nacionales. Como resultado se concluye que las distribuciones Gauss, Gamma, Logística, Log Gauss, Gauss Inversa, Log Logística, Beta y GEV permiten modelar los datos de magnitudes máximas de sismos en Sismos Nacionales.

\section{Resumen de Resultados de Bondad de Ajuste y BIC}

\noindent
A continuación se presenta un resumen de los resultados de las pruebas de bondad de ajuste con las 3 mejores distribuciones encontradas para cada prueba y para el BIC para las diferentes regiones y tipos de datos analizados.

Cabe destacar que en las tablas siguientes, NA indica que no se encontraron distribuciones que cumplieran con los criterios de selección para esa PBA específica, ya que en los resultados de las pruebas de bondad de ajuste (Kolmogorov-Smirnov, Anderson-Darling y Lilliefors) se encuentra que para el dataset de sismos totales ninguna de las distribuciones evaluadas logró pasar las tres pruebas con un p-valor mayor a 0.05 en ninguna de las seis regiones de estudio. Esto indica que los datos de sismos totales no se ajustan adecuadamente a ninguna de las distribuciones analizadas, por lo que se descarta continuar realizando inferencia estadística con este dataset. Este resultado es consistente con la naturaleza de los datos, ya que los sismos totales incluyen eventos de todas las magnitudes registradas mayores a 5.0°, generando una distribución altamente sesgada hacia valores bajos que no corresponde con las distribuciones teóricas evaluadas.

Para el dataset de magnitudes máximas anuales, los resultados permiten identificar distribuciones que se ajustan adecuadamente a los datos de cada región.

En las secciones siguientes se presentan las justificaciones para la elección de la distribución seleccionada para cada una de las regiones de estudio.

\subsection{Oaxaca}

\noindent
La tabla \ref{tab:distribuciones_oaxaca_totales} y la tabla \ref{tab:distribuciones_oaxaca_maximas} muestran las mejores distribuciones encontradas para Oaxaca en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Oaxaca - Sismos Totales.}
\label{tab:distribuciones_oaxaca_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Pareto & NA & NA & NA \\ \hline
2° & Weibull & NA & NA & NA \\ \hline
\rowcolor{gray!20}
3° & Gumbel & NA & NA & NA \\ \hline
\end{tabular}
\end{table}
\endgroup

Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Oaxaca logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Oaxaca - Magnitudes Máximas.}
\label{tab:distribuciones_oaxaca_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Uniforme & GPD & Gumbel & NA \\ \hline
2° & Gamma Inversa & Gamma & Beta & NA \\ \hline
\rowcolor{gray!20}
3° & Beta Prime & Gauss Inv. & Gauss Inv. & NA \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Oaxaca se selecciona la distribución Gumbel. Aunque el criterio BIC sugiere la distribución Uniforme como mejor opción, las pruebas de bondad de ajuste no la respaldan de manera consistente. La distribución Gumbel aparece como la mejor opción en la prueba Anderson-Darling y al graficarla sobre el histograma de magnitudes máximas presenta un ajuste visual adecuado a los datos, lo cual es coherente con la teoría de valores extremos que establece a la distribución Gumbel como apropiada para modelar máximos anuales.

\subsection{Guerrero}

\noindent
La tabla \ref{tab:distribuciones_guerrero_totales} y la tabla \ref{tab:distribuciones_guerrero_maximas} muestran las mejores distribuciones encontradas para Guerrero en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Guerrero - Sismos Totales.}
\label{tab:distribuciones_guerrero_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
...
Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Guerrero logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Guerrero - Magnitudes Máximas.}
\label{tab:distribuciones_guerrero_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Uniforme & Uniforme & Weibull & NA \\ \hline
2° & Gamma & Weibull & GEV & NA \\ \hline
\rowcolor{gray!20}
3° & Normal & GEV & Gauss & NA \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Guerrero se selecciona la distribución Weibull. Esta distribución aparece consistentemente en las pruebas de bondad de ajuste, ocupando la primera posición en Anderson-Darling y la segunda en Kolmogorov-Smirnov. Al comparar visualmente la curva teórica con el histograma de magnitudes máximas, la distribución Weibull se ajusta adecuadamente a la forma y dispersión de los datos sísmicos de esta región.

\subsection{Michoacán}

\noindent
La tabla \ref{tab:distribuciones_michoacan_totales} y la tabla \ref{tab:distribuciones_michoacan_maximas} muestran las mejores distribuciones encontradas para Michoacán en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Michoacán - Sismos Totales.}
\label{tab:distribuciones_michoacan_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
...
Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Michoacán logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Michoacán - Magnitudes Máximas.}
\label{tab:distribuciones_michoacan_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Pareto & GEV & GEV & GEV (0.0471) \\ \hline
2° & Uniforme & Log Logís. & NA & NA \\ \hline
\rowcolor{gray!20}
3° & Weibull Inv. & NA & NA & NA \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Michoacán se selecciona la distribución GEV (Generalizada de Valores Extremos). Esta distribución es la única que logra pasar las tres pruebas de bondad de ajuste, apareciendo en primera posición tanto en Kolmogorov-Smirnov como en Anderson-Darling, y siendo la única con un p-valor aceptable en Lilliefors (0.0471). La distribución GEV es particularmente apropiada para esta región debido a la alta variabilidad sísmica que presenta Michoacán, ya que esta distribución es flexible y puede adaptarse a diferentes comportamientos la cola.

\subsection{Chiapas}

\noindent
La tabla \ref{tab:distribuciones_chiapas_totales} y la tabla \ref{tab:distribuciones_chiapas_maximas} muestran las mejores distribuciones encontradas para Chiapas en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Chiapas - Sismos Totales.}
\label{tab:distribuciones_chiapas_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
...
Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Chiapas logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Chiapas - Magnitudes Máximas.}
\label{tab:distribuciones_chiapas_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Normal & Weibull & Weibull & Weibull \\ \hline
2° & Gamma & T-Student & GEV & GEV \\ \hline
\rowcolor{gray!20}
3° & Gauss Inv. & GEV & Gauss & NA \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Chiapas se selecciona la distribución Weibull. Esta distribución logra pasar las tres pruebas de bondad de ajuste, ocupando la primera posición en Kolmogorov-Smirnov, Anderson-Darling y Lilliefors. El ajuste visual sobre el histograma de magnitudes máximas confirma que la distribución Weibull representa adecuadamente el comportamiento sísmico de esta región, caracterizada por una intensa actividad de sismos fuertes.

\subsection{Resto Nacionales}

\noindent
La tabla \ref{tab:distribuciones_rn_totales} y la tabla \ref{tab:distribuciones_rn_maximas} muestran las mejores distribuciones encontradas para Resto Nacionales en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Resto Nacionales - Sismos Totales.}
\label{tab:distribuciones_rn_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
...
Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Resto Nacionales logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Resto Nacionales - Magnitudes Máximas.}
\label{tab:distribuciones_rn_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Normal & Logística & Logística & Laplace \\ \hline
2° & Gamma & Cauchy & Gauss & Logística \\ \hline
\rowcolor{gray!20}
3° & Logística & Log Logíst. & Log Logíst. & T-Student \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Resto Nacionales se selecciona la distribución Logística. Esta distribución aparece en primera posición en las pruebas Kolmogorov-Smirnov y Anderson-Darling, y en segunda posición en Lilliefors. El criterio BIC también la ubica entre las tres mejores opciones. Al graficar la curva teórica sobre el histograma se observa un buen ajuste, lo cual indica que la distribución Logística captura adecuadamente la simetría y dispersión de las magnitudes máximas en el resto del territorio nacional.

\subsection{Sismos Nacionales}

\noindent
La tabla \ref{tab:distribuciones_sn_totales} y la tabla \ref{tab:distribuciones_sn_maximas} muestran las mejores distribuciones encontradas para Sismos Nacionales en sismos totales y magnitudes máximas, respectivamente.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Sismos Nacionales - Sismos Totales.}
\label{tab:distribuciones_sn_totales}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
...
Como se aprecia, ninguna de las distribuciones evaluadas para sismos totales en Sismos Nacionales logró pasar las tres pruebas de bondad de ajuste con un p-valor mayor a 0.05. Esto indica que los datos de sismos totales en esta región no se ajustan adecuadamente a ninguna de las distribuciones analizadas, lo que sugiere que se deben explorar otras distribuciones o enfoques estadísticos para modelar estos datos de manera más precisa.

\begingroup
\begin{table}[H]
\footnotesize
\centering
\caption{Mejores distribuciones para Sismos Nacionales - Magnitudes Máximas.}
\label{tab:distribuciones_sn_maximas}
\begin{tabular}{|c|c|c|c|c|}
\hline
\rowcolor{gray!60}
\textbf{Posición} & \textbf{BIC} & \textbf{KS} & \textbf{AD} & \textbf{LF} \\ \hline
\rowcolor{gray!20}
1° & Normal & GEV & Gauss & GEV \\ \hline
2° & Log Normal & Gauss & Gamma & Gauss \\ \hline
\rowcolor{gray!20}
3° & Gauss Inv. & Gamma & GEV & Rayleigh \\ \hline
\end{tabular}
\end{table}
\endgroup

Para Sismos Nacionales se selecciona la distribución Normal. Esta distribución ocupa la primera posición en el criterio BIC y aparece consistentemente en las pruebas de bondad de ajuste bajo diferentes denominaciones (Gauss, Normal). El ajuste visual confirma que la distribución Normal representa adecuadamente el comportamiento agregado de las magnitudes máximas a nivel nacional, lo cual sugiere que al consolidar los datos de todas las regiones, la variabilidad se estabiliza y los datos tienden hacia una distribución simétrica.

\section{Graficos de las mejores distribuciones seleccionadas}

\noindent
A continuación se presentan los gráficos de las mejores distribuciones seleccionadas para cada una de las regiones de estudio, superpuestas sobre los histogramas de los datos de magnitudes máximas anuales.

\subsection{Oaxaca}

Como ya se mencionó, para Oaxaca se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución Gumbel, como se aprecia en la figura \ref{fig:curva_gumbel_oaxaca}.
...
Para Guerrero se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución Weibul, como se aprecia en la figura \ref{fig:curva_weibull_guerrero}.
...
Para Michoacán se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución GEV, como se aprecia en la figura \ref{fig:curva_gev_michoacan}.
...
Para Chiapas se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución Weibul, como se aprecia en la figura \ref{fig:curva_weibull_chiapas}.
...
Para Resto Nacionales se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución Logística, como se aprecia en la figura \ref{fig:curva_logistica_resto}.
...
Y para Sismos Nacionales se encontró que el mejor ajuste para valores de máximos anuales lo presenta una distribución Normal, como se aprecia en la figura \ref{fig:curva_normal_nacional}.
